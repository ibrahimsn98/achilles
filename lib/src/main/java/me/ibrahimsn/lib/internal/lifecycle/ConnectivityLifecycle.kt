...
class ConnectivityLifecycle(
    ...
    private fun emitCurrentConnectivity(applicationContext: Context) {
        ...
        lifecycleRegistry.process(toLifecycleState(connectivityManager.isConnected()))
    }
    ...
    private inner class ConnectivityChangeBroadcastReceiver : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            ...
            lifecycleRegistry.process(toLifecycleState(isConnected))
        }
    }
}
